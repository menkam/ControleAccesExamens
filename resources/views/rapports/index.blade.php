...
@section('stylesheets')
    ...
    <!-- PNotify --
    <link href="{{ asset('framework/vendors/pnotify/dist/pnotify.css') }}" rel="stylesheet">
    <link href="{{ asset('framework/vendors/pnotify/dist/pnotify.buttons.css') }}" rel="stylesheet">
    <link href="{{ asset('framework/vendors/pnotify/dist/pnotify.nonblock.css') }}" rel="stylesheet">
    <!-- Custom Theme Style --
