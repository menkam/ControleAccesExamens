function init_sidebar(){
    ...
    var a=$BODY.outerHeight(),b=$BODY.hasClass("footer_fixed")?-10:$FOOTER.height(),
            c=$LEFT_COL.eq(1).height()+$SIDEBAR_FOOTER.height(),d=a<c?c:a;d-=$NAV_MENU.height()+b,
            $RIGHT_COL.css("min-height",d)};$SIDEBAR_MENU.find("a").on("click",function(b){var c=$(this).parent();
...
$(".canvasDoughnut").length)){var a={type:"doughnut",tooltipFillColor:"rgba(51, 51, 51, 0.55)",
    data:{labels:["Presents","Abscents","Fraudeurs"],
    datasets:[{data:[60,30,10],backgroundColor:["green","purple","red"],hoverBackgroundColor:["#A9554F","#B370CF","#CFD4D8"]}]},options:{legend:!1,responsive:!1}};
