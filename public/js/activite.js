...
$(".save_activite").click(function(e){
    ...
    //alert(form_action+id_annee+id_semestre+id_niveau+type_activite+date_debut_activite+date_fin_activite);
...
$(".save_matiere_activite").click(function(e){
   ...
   // alert(id_activite);
    ...
    var date_examen = $("#date_examen").val();
    var id_creneau = $("#id_creneau").val();
    var id_matiere = $("#id_matiere").val();
    var id_surveillant = $("#id_surveillant").val();
    var id_session = $("#id_session").val();

    //alert("id "+id_activite+" date_examen "+date_examen+" id_creneau "+id_creneau+" id_matiere "+id_matiere+" id_surveillant "+id_surveillant+" id_semestre "+id_session);
